...
@tree.command(guild = discord.Object(id=config["serverId"]), name = 'restock', description='Restocks accounts') 
...
@tree.command(guild = discord.Object(id=config["serverId"]), name = 'create', description='Create a new product') 
...
@tree.command(guild = discord.Object(id=config["serverId"]), name = 'delete', description='Deletes product/accounts') 
...
@tree.command(guild = discord.Object(id=config["serverId"]), name = 'dump', description='Get all accounts from product') 
...
#Users commands
@tree.command(guild = discord.Object(id=config["serverId"]), name = 'generate', description='Generate account') 
@app_commands.checks.cooldown(1, config["Cooldown"], key=lambda i: (i.guild_id, i.user.id))
async def genStock(interaction: discord.Interaction):
    ...
    async def getAcc(interaction):
        if author == interaction.user:
            ...
            embed=discord.Embed(title="VertoAlts | Error",description = "help me", color=0xdd0000)
            await interaction.response.send_message(embed=embed,ephemeral = True)
...
@tree.command(guild = discord.Object(id=config["serverId"]), name = 'stats', description='Show statistics about our products') 
...
@tree.command(guild = discord.Object(id=config["serverId"]), name = 'help', description='Shows commands') 
